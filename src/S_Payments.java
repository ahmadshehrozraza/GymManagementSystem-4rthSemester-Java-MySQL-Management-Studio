...
public class S_Payments extends javax.swing.JFrame {
       ...
       public S_Payments() {
        ...
        model.setRowCount(0);
        sData.DisplayListOfPayments(model);
    }
    ...
    private void initComponents() {
        ...
        tb1Data.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Staff Type", "CNIC No.", "Name", "Address", "Mobile No.", "Email", "Amount", "Salary Status"
            }
        ) {
    ...
    private void searchBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBTNActionPerformed
        // TODO add your handling code here:
        model.setRowCount(0);
        sData.DisplayListOfPaymentsSearchingCNIC(model, cnicSearch.getText());
    ...
    private void receivedBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_receivedBTNActionPerformed
        ...
        try {
            ...
            String cCNIC = (String) model.getValueAt(selectedRow, 1);
            String Name = (String) model.getValueAt(selectedRow, 2);
            String Payment = (String) model.getValueAt(selectedRow, 6);
            
            sData.PaidAmount(cCNIC);
            sData.paymentSent(cCNIC, Name,Payment, formattedDate);
        } catch (Exception e) {
    ...
    private void sendMailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendMailActionPerformed
       ...
       if(!(row == -1)){
          if (!(MailMessage.message==null))
        {
            ...
            String mailRecepient = (String) dtm.getValueAt(row, 5);
